...
public class ExamService {
    ...
    public String getScore(String subject, String username) {
        ...
        double score = (double) myUser.getScore(subject) / total;

        return Double.toString(score * 100);
    }
    ...
    public Question getNextQuestion(String email, String ans, String subject) {
        ...
        MyExaminer exam = Examiners.findById(examinerId).get();
        int maxLevel = exam.getLevelOfQustion();
        ...
        if (NewCount < exam.getNumberOfQustions()) {
